...
def map(func: Callable, my_list: Iterable) -> Iterable:
...
def zipWith(func: Callable, my_list1: Iterable, my_list2: Iterable) -> Iterable:
...
def reduce(func: Callable, my_list: Iterable[float]) -> float:
...
def negList(my_list: Iterable) -> Iterable:
...
def addLists(my_list1: Iterable, my_list2: Iterable) -> Iterable:
...
def sum(my_list: Iterable) -> float:
...
def prod(my_list: Iterable) -> float:
